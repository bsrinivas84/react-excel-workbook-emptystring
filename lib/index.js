...
function sheet_from_array_of_arrays(data, columns) {
  var ws = {};
  ...
  for (var R = 0; R != data.length; ++R) {
    for (var C = 0; C != data[R].length; ++C) {
      ...
      } else if (typeof cell.v === "boolean") cell.t = "b";else if (cell.v instanceof Date) {
        cell.t = "n";
...
Column.propTypes = {
  ...
  numFmt: _propTypes2.default.string
};
...
var Workbook = exports.Workbook = function (_Component3) {
  ...
  _createClass(Workbook, [{
    ...
    value: function createSheetData(sheet) {
      var columns = sheet.props.children.filter(function (c) {
        return c && c.props;
      });
      ...
      data.forEach(function (row) {
        ...
        _react2.default.Children.forEach(columns, function (column) {
          ...
          var data = getValue(row) !== 0 && getValue(row) !== "" ? getValue(row) : getValue(row) === 0 ? 0 : "";
          sheetRow.push(data);
        });
    ...
    value: function download() {
      ...
      _react2.default.Children.forEach(this.props.children, function (sheet) {
        if (sheet) {
          ...
          wb.Sheets[sheet.props.name] = sheet_from_array_of_arrays(_this4.createSheetData(sheet), columns);
        }
      });
